 ...
 * uses only main.resources memory to store entries. Obviously this will only improve
 * performance if there is enough physical memory to avoid paging.</li>
 * <li>Low memory requirements.</li>
 * <li>Fast add performance.</li>
 * </ul></p> 
 * 
 * <p>The main.resources reason for the high speed of this RTree implementation is the 
...
//        }
  ...
  private void condenseTree(Node l) {
    ...
    // level as leaves of the main.resources tree
